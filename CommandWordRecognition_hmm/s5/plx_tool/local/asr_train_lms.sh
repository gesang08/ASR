...
text=lm_text/text_seg_by_aishell1_new
...
echo "kaldi_lm start!"
ngram -lm $dir/4gram-mincount/lm_unpruned.gz  -ppl $sdir/heldout
...
ngram -lm $dir/4gram-mincount/lm_pr$thresh.gz  -ppl $sdir/heldout
...
thresh=8.0
prune_lm.sh --arpa 8.0 $dir/4gram-mincount
ngram -lm $dir/4gram-mincount/lm_pr$thresh.gz  -ppl $sdir/heldout

thresh=12.0
prune_lm.sh --arpa 12.0 $dir/4gram-mincount
ngram -lm $dir/4gram-mincount/lm_pr$thresh.gz  -ppl $sdir/heldout


echo "15"
thresh=15.0
prune_lm.sh --arpa 15.0 $dir/4gram-mincount
ngram -lm $dir/4gram-mincount/lm_pr$thresh.gz  -ppl $sdir/heldout

echo "17"
thresh=17.0
prune_lm.sh --arpa 17.0 $dir/4gram-mincount
ngram -lm $dir/4gram-mincount/lm_pr$thresh.gz  -ppl $sdir/heldout
com
echo "16"
thresh=16.0
prune_lm.sh --arpa 16.0 $dir/4gram-mincount
ngram -lm $dir/4gram-mincount/lm_pr$thresh.gz  -ppl $sdir/heldout
